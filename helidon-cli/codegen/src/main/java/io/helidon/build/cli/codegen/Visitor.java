...
final class Visitor {
    ...
    private static final List<String> ARGUMENT_TYPES = Option.Argument.SUPPORTED_TYPES.stream().map(Class::getName).collect(Collectors.toList());
    private static final List<String> KEY_VALUE_TYPES = Option.KeyValue.SUPPORTED_TYPES.stream().map(Class::getName).collect(Collectors.toList());
    private static final List<String> KEY_VALUES_TYPES = Option.KeyValues.SUPPORTED_TYPES.stream().map(Class::getName).collect(Collectors.toList());
