...
final class Visitor {
    ...
    private final ParametersVisitor<FragmentMetaModel<ElementInfo>, CommandFragment> fragmentVisitor = new ParametersVisitor<>(FRAGMENT_PROCESSOR);
    private final ParametersVisitor<CommandMetaModel<ElementInfo>, Command> commandVisitor = new ParametersVisitor<>(COMMAND_PROCESSOR);
    ...
    private class ParametersVisitor<T extends ParametersMetaModel<U, ElementInfo>, U extends Annotation>
        ...
        final ParametersProcessor<T, U> processor;
    ...
    private static abstract class ParametersProcessor<T extends ParametersMetaModel<U, ElementInfo>, U extends Annotation> {

        final Class<U> annotationClass;
    ...
    private static abstract class ParameterProcessor<T extends Annotation> {
