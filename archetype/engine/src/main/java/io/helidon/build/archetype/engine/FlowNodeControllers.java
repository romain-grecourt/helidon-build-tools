...
public class FlowNodeControllers {
     ...
     */
    public static class InputController extends FlowNodeController {
     ...
     */
    public static class SelectController extends FlowNodeController {
        ...
        public void execute() {
            ...
            choices.stream()
                   ...
                   .findFirst()
                   .ifPresent(prop -> System.setProperty(prop.id(), "true"));
        }
    }
