...
class ContextTest {
    ...
    void testPutNonExisting() {
        ...
        assertThat(value.scope().key(true), is("foo.bar"));
        assertThat(value.scope().parent(), is(not(nullValue())));
        assertThat(value.scope().parent().key(true), is("foo"));
    ...
    void testPutExisting() {
        ...
        assertThat(value.scope().key(true), is("foo.bar.bob"));
        assertThat(value.scope().parent(), is(not(nullValue())));
        assertThat(value.scope().parent().key(true), is("foo.bar"));
        assertThat(value.scope().parent().visibility(), is(Visibility.UNSET));
        assertThat(value.scope().parent().parent(), is(not(nullValue())));
        assertThat(value.scope().parent().parent().key(true), is("foo"));
    ...
    void testPathGlobalImplicit() {
        ...
        assertThat(scope.key(true), is("foo.bar"));
    }
    ...
    void testLocal() {
        ...
        assertThat(scope.key(true), is("global.foo.bar"));
    }
    ...
    void testVisitValues() {
        ...
        assertThat(scope.key(true), is(""));
        assertThat(scope.value().isEmpty(), is(true));

        scope = it.next();
        assertThat(scope.key(true), is("foo"));
        ...
        scope = it.next();
        assertThat(scope.key(true), is("bob"));
        assertThat(scope.value().asString().orElse(null), is("bob1"));

        scope = it.next();
        assertThat(scope.key(true), is("bob.alice"));
