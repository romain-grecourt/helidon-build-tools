...
class ExpressionTest {
    ...
    public void testVariable() {
        ...
        assertThat(expression.tree().asBinaryExpression().operator(), is(Operator.EQUAL));
    ...
    public void testContainsOperator() {
        ...
        assertThat(expression.tree().asUnaryExpression().operator(), is(Operator.NOT));
        ...
        assertThat(expression.tree().asBinaryExpression()
                .left().asBinaryExpression()
                .left().asBinaryExpression()
                .operator(), is(Operator.CONTAINS));
        assertThat(expression.tree().asBinaryExpression()
                .left().asBinaryExpression()
                .right().asLiteral().value(), is(true));
        assertThat(expression.tree().asBinaryExpression()
                .left().asBinaryExpression()
                .operator(), is(Operator.EQUAL));
        assertThat(expression.tree().asBinaryExpression()
    ...
    public void testUnaryExpression() {
        ...
        assertThat(left.operator(), is(Operator.NOT_EQUAL));

        value = "'foo1' == 'bar' && !('foo' != ${bar})";
        expression = Expression.builder().expression(value).build();
        assertThat(expression.tree().isBinaryExpression(), is(true));
        assertThat(expression.tree().asBinaryExpression().operator(), is(Operator.AND));
        ...
        assertThat(right.operator(), is(Operator.NOT));
        assertThat(right.left().isBinaryExpression(), is(true));
        assertThat(right.left().asBinaryExpression().operator(), is(Operator.NOT_EQUAL));
    ...
    public void testExpressionWithParenthesis() {
        ...
        assertThat(left.right().isLiteral(), is(true));
        assertThat(left.right().asLiteral().value(), is("\"bar\""));
        assertThat(left.operator(), is(Operator.EQUAL));
        assertThat(expression.tree().asBinaryExpression().operator(), is(Operator.OR));
        ...
        assertThat(right.operator(), is(Operator.OR));
        ...
        assertThat(right.operator(), is(Operator.AND));
        assertThat(right.left().isBinaryExpression(), is(true));
        assertThat(right.left().asBinaryExpression().operator(), is(Operator.OR));
    ...
    public void testFewOperatorsWithDifferentPrecedenceInOneExpression() {
        ...
        assertThat(left.left().asBinaryExpression().operator(), is(Operator.EQUAL));
        assertThat(left.right().isLiteral(), is(true));
        assertThat(left.right().asLiteral().value(), is("'foo1'"));
        assertThat(left.operator(), is(Operator.AND));
        assertThat(expression.tree().asBinaryExpression().operator(), is(Operator.OR));
        assertThat(expression.tree().asBinaryExpression().right().isLiteral(), is(true));
        ...
        assertThat(right.operator(), is(Operator.EQUAL));
        ...
        assertThat(left.right().asBinaryExpression().operator(), is(Operator.EQUAL));
