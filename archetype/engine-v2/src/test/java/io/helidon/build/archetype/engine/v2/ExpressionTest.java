...
class ExpressionTest {
    ...
    @Test
    void testComplex() {
        Expression expr = expr("!(${metrics} || ${tracing} || ${health}) || (${metrics} && ${tracing} && ${health})");
    ...
    void testSub() {
        ...
        assertThat(expr("false").sub(expr("false")),
                is(expr("false")));
        assertThat(expr("true").sub(expr("${a} == '0'")),
                is(expr("true")));
        assertThat(expr("'abc' contains 'a'").sub(expr("${a} == '0'")),
                is(expr("true")));
        assertThat(expr("false").sub(expr("${a} == '0'")),
                is(expr("false")));
        assertThat(expr("'abc' contains 'd'").sub(expr("${a} == '0'")),
                is(expr("false")));
        assertThat(expr("${a} == '1'").sub(expr("${a} == '1'")),
                is(expr("true")));
        assertThat(expr("${a} == '1'").sub(expr("${a} == '0'")),
                is(expr("${a} == '1'")));
        assertThat(expr("${a} == '1' && ${b} == '2'").sub(expr("${a} == '1'")),
                is(expr("${b} == '2'")));
        assertThat(expr("${a} == '1' && ${b} == '2' && ${c} == '3'").sub(expr("${a} == '1'")),
                is(expr("${b} == '2' && ${c} == '3'")));
        assertThat(expr("${a} == '1' && ${b} == '2' && ${c} == '3'").sub(expr("${a} == '1' && ${b} == '2'")),
                is(expr("${c} == '3'")));
