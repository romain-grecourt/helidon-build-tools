...
//        ContextNode node2 = new ContextNode("node2", null);
//        List<ContextNode> list = new LinkedList<>();
//        list.add(node2);
//        ContextNode node1 = new ContextNode("node1", list);
//        list = new LinkedList<>();
//        list.add(node1);
//        ContextNode node0 = new ContextNode("base", list);
//        list = new LinkedList<>();
//        list.add(node0);
//        ContextNode rootNode = new ContextNode("flavor", list);
//
...
//        //              \-> wrongPath                 \-> wrongPath
//        ContextNode node6 = new ContextNode("wrongPath", null);
//        ContextNode node5 = new ContextNode("provider", null);
//        List<ContextNode> list = new LinkedList<>();
//        list.add(node5);
//        list.add(node6);
//        ContextNode node4 = new ContextNode("authentication", list);
//        list = new LinkedList<>();
//        list.add(node4);
//        ContextNode node3 = new ContextNode("security", list);
//        list = new LinkedList<>();
//        list.add(node3);
//        list.add(node6);
//        ContextNode node2 = new ContextNode("base", list);
//        list = new LinkedList<>();
//        list.add(node2);
//        ContextNode root = new ContextNode("flavor", list);
//        list = new LinkedList<>();
//        list.add(root);
//
...
//        list = new LinkedList<>();
//        list.add(node1);
//        ContextNode base = new ContextNode("base", list);
//        list = new LinkedList<>();
//        list.add(base);
//        ContextNode root = new ContextNode("flavor", list);
//
