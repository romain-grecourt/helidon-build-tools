...
public interface Node {
     ...
     * Empty node.
     */
    Node EMPTY = builder(Kind.UNKNOWN).build();
    ...
    /**
     * Update an attribute if present.
     *
     * @param name   attribute name
     * @param mapper mapping function
     * @return this node
     */
    default Node attribute(String name, Function<Value<?>, Value<?>> mapper) {
        attributes().computeIfPresent(name, (k, v) -> mapper.apply(v));
        return this;
    }
