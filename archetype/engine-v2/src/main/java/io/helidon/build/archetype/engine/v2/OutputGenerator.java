...
//        }
//
//        List<ArchetypeDescriptor.Replacement> replacements = transformations.stream()
//                                                                            .filter(t -> applicable.contains(t.descriptor().id()))
//                                                                            .flatMap((t) -> t.descriptor().replacements().stream())
//                                                                            .collect(toList());
//
//        for (ArchetypeDescriptor.Replacement rep : replacements) {
...
//    }
//
//    private ArchetypeDescriptor.Model convertASTModel(ModelNode model) {
//        ArchetypeDescriptor.Model modelDescriptor = new ArchetypeDescriptor.Model("true");
...
//    }
//
//    private Collection<? extends ArchetypeDescriptor.ModelKeyedMap> convertASTKeyMaps(List<ModelKeyedMapNode> astMaps) {
//        LinkedList<ArchetypeDescriptor.ModelKeyedMap> maps = new LinkedList<>();
//        for (ModelKeyedMapNode map : astMaps) {
//            ArchetypeDescriptor.ModelKeyedMap keyMap = new ArchetypeDescriptor.ModelKeyedMap(
//                    map.descriptor().key(),
...
//    }
//
//    private Collection<? extends ArchetypeDescriptor.ModelKeyedList> convertASTKeyLists(List<ModelKeyedListNode> astLists) {
//        LinkedList<ArchetypeDescriptor.ModelKeyedList> lists = new LinkedList<>();
//        for (ModelKeyedListNode list : astLists) {
//            ArchetypeDescriptor.ModelKeyedList keyList = new ArchetypeDescriptor.ModelKeyedList(
//                    list.descriptor().key(),
...
//    }
//
//    private Collection<? extends ArchetypeDescriptor.ModelKeyedValue> convertASTKeyValues(List<ModelKeyedValueNode> astValues) {
//        LinkedList<ArchetypeDescriptor.ModelKeyedValue> values = new LinkedList<>();
//        for (ModelKeyedValueNode value : astValues) {
//            ArchetypeDescriptor.ModelKeyedValue keyValue = new ArchetypeDescriptor.ModelKeyedValue(
...
//    }
//
//    private Collection<? extends ArchetypeDescriptor.ModelValue> convertASTValues(List<ModelValueNode<?>> astValues) {
//        LinkedList<ArchetypeDescriptor.ModelValue> values = new LinkedList<>();
//        for (ModelValueNode<?> value : astValues) {
//            ArchetypeDescriptor.ModelValue valueType = new ArchetypeDescriptor.ModelValue(
//                    value.descriptor().url(),
//                    value.descriptor().file(),
//                    value.descriptor().template(),
//                    value.descriptor().order(),
...
//    }
//
//    private Collection<? extends ArchetypeDescriptor.ModelList> convertASTLists(List<ModelListNode<?>> astList) {
//        LinkedList<ArchetypeDescriptor.ModelList> lists = new LinkedList<>();
//        for (ModelListNode<?> list : astList) {
//            ArchetypeDescriptor.ModelList listType = new ArchetypeDescriptor.ModelList(list.descriptor().order(), "true");
...
//    }
//
//    private Collection<? extends ArchetypeDescriptor.ModelMap> convertASTMaps(List<ModelMapNode<?>> mapNode) {
//        LinkedList<ArchetypeDescriptor.ModelMap> maps = new LinkedList<>();
//        for (ModelMapNode<?> map : mapNode) {
//            ArchetypeDescriptor.ModelMap modelMap = new ArchetypeDescriptor.ModelMap(map.descriptor().order(), "true");
...
//    }
//
//    private void convertKeyElements(LinkedList<ArchetypeDescriptor.ModelKeyedValue> modelKeyValues,
//                                    LinkedList<ArchetypeDescriptor.ModelKeyedList> modelKeyLists,
//                                    LinkedList<ArchetypeDescriptor.ModelKeyedMap> modelKeyMaps,
...
//    }
//
//    private void convertElements(LinkedList<ArchetypeDescriptor.ModelValue> values,
//                                 LinkedList<ArchetypeDescriptor.ModelList> lists,
//                                 LinkedList<ArchetypeDescriptor.ModelMap> maps,
//                                 List<ASTNode> children) {
//
...
//    }
//
//    private List<OutputNode> getOutputNodes(List<ASTNode> nodes) {
//        return nodes.stream()
