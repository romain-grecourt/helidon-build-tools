...
class ScriptCompilerExt {
     ...
     * Compiler features.
     */
    enum Features implements ScriptCompiler.Feature {
        VALIDATE_REGEX(ScriptCompilerExt::validateRegex, 0),
        VALIDATE_SCHEMA(ScriptCompilerExt::validateSchema, 0);
